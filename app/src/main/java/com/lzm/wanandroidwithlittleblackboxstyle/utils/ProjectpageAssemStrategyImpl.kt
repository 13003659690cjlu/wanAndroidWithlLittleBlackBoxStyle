...
class ProjectpageAssemStrategyImpl:ITopTabAssemblyStrategy {
    private val logger: org.slf4j.Logger? = LoggerFactory.getLogger(ProjectpageAssemStrategyImpl::class.java)
    override fun AssemblyStrategy(leftTab: TabLayout, rightTab: TabLayout) {
        leftTab.removeAllTabs()
        val buttonTitleArray= arrayOf("项目")
