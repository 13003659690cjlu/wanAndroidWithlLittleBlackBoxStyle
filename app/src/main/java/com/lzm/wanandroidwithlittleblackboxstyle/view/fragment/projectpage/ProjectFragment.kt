...
import com.lzm.wanandroidwithlittleblackboxstyle.view.fragment.accountpage.DataFragment
...
class ProjectFragment(viewModel: BaseViewModel) : BaseFragment(viewModel) {
    ...
    private val fragments: List<Fragment> by lazy {
        listOf(RecommendProjectFragment())
    }
...
//        装配顶部tablayout
        val buttonTitleArray= arrayOf("热门项目")
//        viewpage绑定tablayout
